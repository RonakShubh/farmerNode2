...
export const getcontractor = async (req, mainUserId, createdBy) => {
  ...
  let totalrecord = await contractorModel.findWithCount("contractorModel",where);
  var results = await contractorModel.findOrderWithSort("contractorModel",
    where,
    sort,
    skiprecord,
    limit
...
export const deletecontractor = async (req, mainUserId, createdBy) => {
  let cid = req.body.id;
    ...
    let contractordata = await contractorModel.findByConditionAndUpdate("contractorModel", where, {
      isDeleted: true,
    });
...
export const updatecontractor = async (req, mainUserId, createdBy) => {
  ...
  if (req.body.email == "" || !req.body.email) {
    let project = await contractorModel.findByConditionAndUpdate("contractorModel",
